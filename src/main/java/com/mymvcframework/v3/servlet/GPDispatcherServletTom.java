 ...
 */
public class GPDispatcherServletTom extends HttpServlet{
...
//        if(!this.handlerMapping.containsKey(url)){
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if(!clazz.isAnnotationPresent(CLController.class)){continue;}
            //保存写在类上面的@CLRequestMapping("/demo")
            String baseUrl = "";
            if(clazz.isAnnotationPresent(CLRequestMapping.class)){
                CLRequestMapping requestMapping = clazz.getAnnotation(CLRequestMapping.class);
                baseUrl = requestMapping.value();
            }

            //默认获取所有的public方法
            for (Method method : clazz.getMethods()) {
                if(!method.isAnnotationPresent(CLRequestMapping.class)){continue;}
    ...
    private void doAutowired() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            for (Field field : fields) {
                if(!field.isAnnotationPresent(CLAutowired.class)){continue;}
